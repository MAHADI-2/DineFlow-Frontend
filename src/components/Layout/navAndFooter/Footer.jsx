...
const Footer = () => {
  return (
    <footer className="bg-gray-900 text-gray-300 pt-16 pb-8 mt-auto">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-4 gap-10">
        ...
        <div>
          ...
          <div className="flex space-x-3">
            {/* Facebook SVG */}
            <a href="#" className="w-10 h-10 rounded-full bg-gray-800 flex items-center justify-center hover:bg-orange-500 hover:text-white transition">
        ...
        {/* Quick Links */}
        <div>
          <h3 className="text-lg font-semibold text-white mb-4 border-b border-gray-800 pb-2">Quick Links</h3>
        ...
        {/* Opening Hours */}
        <div>
          <h3 className="text-lg font-semibold text-white mb-4 border-b border-gray-800 pb-2">Opening Hours</h3>
          <ul className="space-y-2 text-sm text-gray-400">
            <li>Monday - Friday: <span className="text-white">10:00 AM - 11:00 PM</span></li>
            <li>Saturday - Sunday: <span className="text-white">11:00 AM - 12:00 PM</span></li>
            <li className="text-orange-400 font-medium pt-2">Home Delivery Available!</li>
          </ul>
        </div>

        {/* Contact Info */}
        <div>
          <h3 className="text-lg font-semibold text-white mb-4 border-b border-gray-800 pb-2">Contact Us</h3>
          <ul className="space-y-3 text-sm text-gray-400">
            <li className="flex items-start space-x-3">
              <MapPin className="text-orange-500 mt-1 shrink-0" size={18} />
              <span>123 Food Street, Gulshan, Dhaka, Bangladesh</span>
            </li>
      ...
      {/* Bottom Bar */}
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-12 pt-6 border-t border-gray-800 text-center text-sm text-gray-500">
